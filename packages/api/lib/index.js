    ...
    var n = r(1),
      ...
      d = function e(t, r, o, i, c, u, s, d, p, y, h, m, b) {
        ...
        if (
          ...
          if (i) return u && !m ? u(r, l.encoder, b) : r;
          g = '';
        }
        if (
          'string' == typeof g ||
          ...
          return u
            ? [h(m ? r : u(r, l.encoder, b)) + '=' + h(u(g, l.encoder, b))]
            : [h(r) + '=' + h(String(g))];
        var v,
          j = [];
    ...
    var n = r(1),
      ...
      a = function(e, t, r) {
        if (e) {
          ...
          for (var f = 0; null !== (c = i.exec(n)) && f < r.depth; ) {
            if (
              ((f += 1),
              !r.plainObjects &&
  ...
  function(e, t, r) {
    ...
    var n = { API_URL: 'ordered.online' },
      ...
      i =
        (o(),
        function(e) {
          return fetch('ordered.online/verification/register/', {
            method: 'post',
      ...
      c = function(e, t) {
        return fetch('ordered.online/verification/verify/', {
          method: 'post',
      ...
      a = function(e, t) {
        return fetch('ordered.online/verification/login/', {
          method: 'post',
      ...
      u = function(e, t) {
        return fetch('ordered.online/verification/logout/', {
          method: 'post',
          body: JSON.stringify({ sessionKey: e, userId: t }),
        }).then(function(e) {
          return e.json();
      ...
      s = o().API_URL,
      l = function(e) {
        return fetch(s + '/locations/create/', {
          method: 'post',
          body: JSON.stringify(e),
        }).then(function(e) {
          return e.json();
      ...
      d = function(e, t) {
        return fetch(s + '/locations/edit/' + e, {
          method: 'post',
      ...
      p = function(e) {
        return fetch(s + '/locations/get/' + e, { method: 'post' }).then(
          function(e) {
            return e.json();
          }
        );
      ...
      y = function(e) {
        var t = s + '/locations/find/' + f.stringify(e, { addQueryPrefix: !0 });
      ...
      h = function(e) {
        var t =
          s + '/locations/nearby/' + f.stringify(e, { addQueryPrefix: !0 });
        return fetch(t, { method: 'post' }).then(function(e) {
          return e.json();
        });
      },
